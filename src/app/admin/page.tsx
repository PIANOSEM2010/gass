...
export default async function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Pengguna", value: totalUsers || 0, icon: Users, color: "bg-blue-100 text-sky-300" },
    ...
    { label: "Marker Aktif", value: totalApprovedMarkers || 0, icon: MapPin, color: "bg-green-100 text-lime-300" },
    { label: "Post Forum", value: totalPosts || 0, icon: MessageSquare, color: "bg-purple-100 text-purple-700", href: "/admin/forum" },
    { label: "Total SOS", value: totalSos || 0, icon: Siren, color: "bg-red-100 text-red-300", href: "/admin/sos" },
