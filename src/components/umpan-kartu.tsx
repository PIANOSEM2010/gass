...
export default function KartuAktivitas({ a, masuk }: { a: Aktivitas; masuk: boolean }) {
  ...
  return (
    <article className="rounded-2xl border border-lime-400/12 bg-[#0C1A15] overflow-hidden">
      ...
      <div className="mt-3 px-2">
        <div className="rounded-xl bg-[#08120F] border border-lime-400/8 py-3 flex justify-center">
      ...
      <div className="flex items-end gap-6 px-4 pt-3">
        <div>
          <p className="display-num text-[22px] leading-none text-white">
