...
const FITUR = [
  ...
  { href: "/dashboard", label: "Dasbor Keselamatan", ket: "Data keselamatan pesepeda", ikon: IkonDasbor, warna: "#FB7185" },
  { href: "/event", label: "Event Gowes", ket: "Gowes bareng bersama komunitas", ikon: IkonKampanyeJalan, warna: "#FB923C" },
