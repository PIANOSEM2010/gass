  ...
  return (
    <div className="min-h-screen bg-[#071310] pb-10">
      <div className="max-w-md mx-auto px-5 pt-6">
        ...
        {/* Lokasi */}
        <div className="mt-5 rounded-2xl border border-lime-400/15 bg-[#0C1A15] p-4">
        ...
        <div className="rounded-2xl border border-white/8 bg-[#0C1A15] divide-y divide-white/5">
          {naskah.map((baris, i) => (
        ...
        <div className="space-y-2">
          {daftarPeriksa.map((t, i) => (
            <button key={i} onClick={() => tandai(i)}
              className={`w-full flex items-start gap-2.5 text-left rounded-xl border px-3.5 py-3 transition-colors ${langkah[i] ? "border-lime-400/35 bg-lime-400/8" : "border-white/8 bg-[#0C1A15]"}`}>
        ...
        <div className="mt-6 rounded-xl border border-white/8 bg-[#0A1512] p-4">
